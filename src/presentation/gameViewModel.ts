...
const decisionReasonLabels: Readonly<Record<string, string>> = {
  ...
  "no physical threat blocks the route": "진로를 막는 물리적 위협이 없습니다.",
  ...
  "misinformation requires investigation": "오정보의 출처를 직접 조사해야 합니다.",
  ...
  "an imminent physical threat requires a defensive posture": "임박한 물리적 위협 때문에 방어 태세가 필요합니다.",
  ...
  "misinformation requires independent verification": "오정보를 독립적으로 검증해야 합니다.",
  ...
  "communications disruption requires a fresh broadcast": "통신 장애를 넘기 위해 새 상황 전파가 필요합니다.",
